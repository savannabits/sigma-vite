				...
				<DataTable :value="customer1" :paginator="true" class="p-datatable-gridlines" :rows="10" dataKey="id" :rowHover="true" 
					...
					<template #header>
                        <div class="flex justify-content-between flex-column sm:flex-row">
                            <Button type="button" icon="pi pi-filter-slash" label="Clear" class="mb-2 p-button-outlined" @click="clearFilter1()"/>
                    ...
                    <Column field="activity" header="Activity" :showFilterMatchModes="false" style="min-width:12rem">
                        ...
                        <template #filter={filterModel}>
                            ...
                            <div class="flex px-2 align-items-center justify-content-between">
				...
				<DataTable :value="customer3" rowGroupMode="subheader" groupRowsBy="representative.name"
                    ...
                    <Column field="country" header="Country" style="min-width:200px">
                        <template #body="slotProps">
                            ...
                            <span class="ml-2 image-text">{{slotProps.data.country.name}}</span>
                        </template>
                    </Column>
                    ...
                    <template #groupfooter="slotProps">
                        <td style="text-align: right" class="pr-6 text-bold">Total Customers: {{calculateCustomerTotal(slotProps.data.representative.name)}}</td>
                    </template>
                </DataTable>
			</div>
		</div>
